        ...
        <div className="p-6">
          {success ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-400 mb-6">Your combo has been successfully scheduled.</p>
              <button
                onClick={onClose}
              ...
              <div className="mb-6">
                ...
                <div className="bg-gray-800/30 border border-gray-700/50 rounded-xl p-4 mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-gold">{combo.name}</h3>
                      <p className="text-sm text-gray-400">
                        ₹{combo.totalPrice} • {combo.services.length} services
                      </p>
                    </div>
                  </div>
                </div>
